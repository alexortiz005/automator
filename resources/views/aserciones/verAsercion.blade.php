		...
		<div class="header clearfix">
			...
			<div class="jumbotron">
				<center>
					...
					<h1 class="display-3"> VARIABLE {{$asercion->variable}}</h1>       
				</center>
				...
				<div class="panel panel-default">
					<div class="panel-heading">
						<h4 class="panel-title">
							<a data-toggle="collapse" data-parent="#accordion" href="#collapse1"><strong>Información</strong></a></h4>
						</div>
								...
								<div class="panel-body">
									<div class="row">
										<div class="col-md-6">
											...
											{{csrf_field()}}
											<input type="hidden" name="id" value="{{$asercion->id}}">

											<label class="control-label col-sm-3 " for="estado">Id en BD</label>

											<div class="input-group"> 
												<span class="input-group-addon" id="basic-addon1">#</span>
												<input class="form-control" name="id" placeholder="Id" aria-describedby="basic-addon1" value="{{$asercion->id}}" disabled> 
											</div> <br> 
											...
											<div class="input-group"> 
												...
												<input class="form-control" name="variable" placeholder="Variable" aria-describedby="basic-addon1" value="{{$asercion->variable}}"> 
											</div> <br> 
											...
											<div class="input-group"> 
												<span class="input-group-addon" id="basic-addon1"><span class="glyphicon glyphicon-pencil"></span></span>
												<input class="form-control" name="objeto" placeholder="Objeto" aria-describedby="basic-addon1" value="{{$asercion->objeto}}"> 
											</div> <br> 
											...
											<div class="input-group"> 
												<span class="input-group-addon" id="basic-addon1"><span class="glyphicon glyphicon-pencil"></span></span>
												<textarea class="form-control"  name="ruta" placeholder="Ruta" aria-describedby="basic-addon1" >{{$asercion->ruta}}</textarea>
											...
											<div class="input-group"> 
												<span class="input-group-addon" id="basic-addon1"><span class="glyphicon glyphicon-pencil"></span></span>
												<textarea class="form-control" name="descripcion" placeholder="Descripción" aria-describedby="basic-addon1" >{{$asercion->descripcion}}</textarea> 
											</div> <br> 
											...
											<div class="input-group"> 
												<span class="input-group-addon" id="basic-addon1"><span class="glyphicon glyphicon-pencil"></span></span>
												<textarea class="form-control" name="descripcion_formateada" placeholder="Descripción" aria-describedby="basic-addon1" >{{$asercion->descripcion_formateada}}</textarea> 
											</div> <br> 
							<!-- 
							<div class="input-group"> 
				...
				<div class="row" style="overflow: scroll; overflow-y: hidden;">     							
					...
					<div class="col-md-12" style="margin: 10px" >
						<table class="table table-bordered table-responsive" >
							...
							<tbody>
								@foreach($keywords_asercion as $indexKeyword=>$keyword)
								<tr>
									<td>
...
<div class="panel panel-default">
	...
	<div id="collapse3" class="panel-collapse collapse">
		<div class="panel-body">
		<form method="post" action="/eliminarAsercion">


				<form action="/eliminarAsercion" method="post" id="formEliminarAsercion">
			    	{{csrf_field()}}
			    	<input type="hidden" name="idAsercion" value="{{$asercion->id}}">
			    	<button type="submit" id="botonEliminarAsercion" class="btn btn-danger"  > 
			    		Eliminar asercion
			    		<span class="glyphicon glyphicon-trash"></span> 
			    	</button>
			    	<script type="text/javascript">
			    		$( "#botonEliminarAsercion" ).click(function( event ) {
						  event.preventDefault();
						  if(confirm('¿Esta seguro de las concecuencias que traera esto?'))
						  	$('#formEliminarAsercion').submit();	
